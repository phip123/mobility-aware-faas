...
class HorizontalPodOptimizer(ScalerSchedulerOptimizer):
    """
    ...
    def run(self, ctx: Context) -> HpaScalerSchedulerResult:
        """
        ...
        return HpaScalerSchedulerResult(decisions=hpa_decisions, scale_schedule_events=scale_schedule_events)
