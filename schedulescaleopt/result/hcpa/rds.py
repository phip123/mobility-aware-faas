...
from schedulescaleopt.opt.api import ScaleScheduleEvent, HcpaDecision, \
    HcpaScalerSchedulerResult
from schedulescaleopt.result.api import ResultConsumer

logger = logging.getLogger(__name__)


class RedisHcpaResultConsumer(ResultConsumer):
    ...
    def consume(self, scaler: HcpaScalerSchedulerResult):
        logger.info("redis result consumer is publishing the results...")

        self._publish(scaler.decisions, 'decision', HcpaDecision)
