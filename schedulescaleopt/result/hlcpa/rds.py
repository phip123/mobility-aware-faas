...
from schedulescaleopt.opt.api import ScaleScheduleEvent, HlcpaScalerSchedulerResult, HlcpaDecision
from schedulescaleopt.result.api import ResultConsumer

logger = logging.getLogger(__name__)


class RedisHlcpaResultConsumer(ResultConsumer):
    ...
    def consume(self, scaler: HlcpaScalerSchedulerResult):
        logger.info("redis result consumer is publishing the results...")

        self._publish(scaler.decisions, 'decision', HlcpaDecision)
