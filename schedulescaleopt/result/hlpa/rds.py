...
from schedulescaleopt.opt.api import ScaleScheduleEvent, HlpaScalerSchedulerResult, HlpaDecision
from schedulescaleopt.result.api import ResultConsumer

logger = logging.getLogger(__name__)


class RedisHlpaResultConsumer(ResultConsumer):
    ...
    def consume(self, scaler: HlpaScalerSchedulerResult):
        logger.info("redis result consumer is publishing the results...")

        self._publish(scaler.decisions, 'decision', HlpaDecision)
