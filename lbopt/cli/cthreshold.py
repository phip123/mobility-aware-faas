...
from lbopt.opt.clusteredthreshold import ClusteredThresholdBasedWeightOptimizer
...
def main():
    ...
    try:
        ...
        threshold_based_weight_optimizer = ClusteredThresholdBasedWeightOptimizer.read_from_env()
